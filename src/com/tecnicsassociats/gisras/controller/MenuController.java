...
import com.tecnicsassociats.gisras.gui.AboutDialog;
import com.tecnicsassociats.gisras.gui.LicenseDialog;
import com.tecnicsassociats.gisras.gui.MainFrame;
import com.tecnicsassociats.gisras.gui.WelcomeDialog;
...
public class MenuController {
	...
	public void showWelcome() {
		...
		String info = "Welcome to the GIS & HEC-RAS comunication tool";
	...
	public void showAuthor() {
		String version = "gisRAS version " + prop.getProperty("VERSION_CODE");
	...
	public void showAgreements() {
		...
		String info2 = "Tècnics Associats, engineering & geospatial solutions";
		WelcomeDialog about = new WelcomeDialog(title, info, info2);
		about.setModal(true);
		about.setLocationRelativeTo(null);
		about.setVisible(true);
